...
public class aboutUs extends JFrame {
 ...
 public aboutUs() {
            ...
            JLabel l6 = new JLabel(" By : Supriya Tiwari");
            l6.setFont(new Font("Trebuchet MS", Font.BOLD, 30));
            l6.setBounds(70, 198, 600, 35);
            contentPane.add(l6);

            JLabel l7 = new JLabel("Library Management System is a project which\n aims in developing a system to\n maintain all the daily work of a library. the system helps both\n students and library manager to keep a constant track\n of all the books available in the library. it allows both the\n admin and the student to search for the desired book.");
            
           //// 17.setForeground(new color(30, 144, 255));
             // 17.setFont(new Font("Trebuchet MS",Font.BOLD, 25));
             ///17.setBounds(new Font(70,260,600,200);
            //contentPane.add(17);
